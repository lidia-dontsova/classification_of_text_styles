# Предобработка художественных текстов
...
if __name__ == '__main__':
    df = pd.read_csv('/Users/lidia.donts/Documents/учеба/python_projects/text-styles/cmd/datasets/artistic_2000.csv')

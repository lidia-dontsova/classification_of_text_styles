# Предобработка текстов для классификации стилей
...
if __name__ == '__main__':
    df = pd.read_csv('/Users/lidia.donts/Documents/учеба/python_projects/text-styles/cmd/datasets/conversational_2000.csv')
    ...
    df[['text_ready', 'label', 'style', 'style_ru']].to_csv(
        'conversational_preprocessed.csv',
        index=False, encoding='utf-8-sig'
    )
    print(f'Строк: {len(df)}, ср. токенов: {df["token_count"].mean():.1f}')

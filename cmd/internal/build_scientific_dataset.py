# Сборка датасета научных текстов
...
SCIENTIFIC_DIR = ROOT / "draft" / "scientific"
OUT_PATH = ROOT / "datasets" / "scientific_2000.csv"
...
def main() -> None:
    all_chunks: list[str] = []
    for path in sorted(SCIENTIFIC_DIR.rglob("*.txt")):
    ...
    print(f"Сохранено: {len(sampled)} -> {OUT_PATH}")
